...
% Exercise
\newtcbtheorem[use counter from=mydefinition]{myexercise}{Exercise}
{
    enhanced,
    % frame hidden,
    titlerule=0mm,
    ...
    colback=white % yellow!20!white,
    % colbacktitle=blue,  % 将标题背景改为蓝色
    % colback=white,  % 将背景改为无色
    %colframe=lightblue,  % 添加淡蓝色边框
}{ex}
